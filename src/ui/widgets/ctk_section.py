        ...
        **kwargs: Any,
        ...
        if title:
            ...
            self.title_label.pack(
                fill="x", padx=self._pad_x, pady=(self._pad_y if isinstance(self._pad_y, int) else self._pad_y[0], 4)
            )
        else:
        ...
        self.content_frame.pack(fill="both", expand=True, padx=self._pad_x, pady=content_pady)
