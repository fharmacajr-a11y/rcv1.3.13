...
class SubpastaDialog(tk.Toplevel):
    ...
    def __init__(
        ...
        ttk.Label(tree_frame, text="Subpastas existentes (clique duplo para selecionar):").pack(
            anchor="w", pady=(0, 5)
        )
        ...
        ttk.Button(btn_frame, text="Atualizar Lista", command=self._load_subpastas).pack(
            side="left"
        )
