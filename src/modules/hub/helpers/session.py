# -*- coding: utf-8 -*-
"""Helpers de sessão, autenticação e utilitários gerais do Hub.

═══════════════════════════════════════════════════════════════════════════════
MÓDULO: hub/helpers/session.py
CONTEXTO: ORG-003 - Consolidação de helpers de sessão
═══════════════════════════════════════════════════════════════════════════════

Este módulo contém funções relacionadas à:
- Autenticação e verificação de sessão
- Formatação de autores e emails
- Lógica de cooldown/retry
- Acesso seguro a App/auth/org_id

FONTES ORIGINAIS:
- src/modules/hub/views/hub_helpers_session.py (funções de autenticação/cooldown)
- src/modules/hub/services/hub_auth_helpers.py (funções de acesso a widget/auth)

HISTÓRICO:
- MF-18: Criação de hub_helpers_session.py
- MF-35: Criação de hub_auth_helpers.py
- ORG-003: Consolidação em helpers/session.py
═══════════════════════════════════════════════════════════════════════════════
"""
...
# =========================================================================
# FORMATAÇÃO DE EMAILS E AUTORES
# =========================================================================
...
# =========================================================================
# ACESSO SEGURO A APP/AUTH/ORG_ID (de hub_auth_helpers.py)
# =========================================================================
