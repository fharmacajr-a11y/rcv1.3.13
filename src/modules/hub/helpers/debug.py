# -*- coding: utf-8 -*-
"""Helpers de debug e diagnóstico para o Hub.

═══════════════════════════════════════════════════════════════════════════════
MÓDULO: hub/helpers/debug.py
CONTEXTO: ORG-003 - Consolidação de helpers de debug
═══════════════════════════════════════════════════════════════════════════════
...
- MF-36: Adição de hub_dlog e collect_full_notes_debug
- ORG-003: Movido para helpers/debug.py
═══════════════════════════════════════════════════════════════════════════════
"""
