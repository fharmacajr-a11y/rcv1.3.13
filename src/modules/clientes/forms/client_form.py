...
from src.ui.window_utils import center_on_parent as center_on_parent  # noqa: F401
from src.modules.clientes.components.status import apply_status_prefix as apply_status_prefix  # noqa: F401
from src.modules.clientes.components.helpers import (  # noqa: F401
    STATUS_CHOICES as STATUS_CHOICES,
    STATUS_PREFIX_RE as STATUS_PREFIX_RE,
)
from src.modules.clientes.service import (
    salvar_cliente_a_partir_do_form as salvar_cliente_a_partir_do_form,  # noqa: F401
    checar_duplicatas_para_form as checar_duplicatas_para_form,  # noqa: F401
)
...
from ._dupes import (  # noqa: F401
    has_cnpj_conflict as has_cnpj_conflict,
    has_razao_conflict as has_razao_conflict,
    ask_razao_confirm as ask_razao_confirm,
...
# Alias para compatibilidade de testes
log = logger
...
def form_cliente(
    ...
    class Handlers:
        ...
        def on_dirty(self, *args: Any) -> None:  # noqa: ARG002 - Callback signature
