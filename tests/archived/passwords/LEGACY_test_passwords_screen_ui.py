"""LEGACY TEST - UI da Tela de Senhas

Este arquivo cobre a UI antiga da tela de senhas (FIX-SENHAS-002).
...
pytestmark = [
    ...
    pytest.mark.skip(reason="UI antiga de senhas, mantida apenas como referência histórica"),
]
