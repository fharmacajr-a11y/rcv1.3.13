"""LEGACY TEST - UI Antiga de Senhas

Este arquivo cobre a UI antiga (src/ui/passwords_screen.py).
...
pytestmark = [pytest.mark.legacy_ui, pytest.mark.skip(reason="UI antiga, mantida apenas como referência histórica")]
