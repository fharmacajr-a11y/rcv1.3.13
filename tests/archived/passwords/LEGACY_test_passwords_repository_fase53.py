"""LEGACY TEST - Repositório Antigo de Senhas (Fase 53)

Este arquivo cobre o repositório antigo de senhas.
...
pytestmark = [
    ...
    pytest.mark.skip(reason="Repositório antigo, mantido apenas como referência histórica"),
]
