...
def temp_prefs_dir(isolated_prefs_dir):
    ...
    """
    # isolated_prefs_dir já fez o monkeypatch de _get_base_dir
...
def test_corrupted_prefs_file_returns_empty(temp_prefs_dir):
    ...
    # Usar um user_key único para este teste
    loaded = load_columns_visibility("corrupted_test@unique.com")
    assert loaded == {}
