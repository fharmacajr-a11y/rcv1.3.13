...
def test_httpx_timeout_alias_import():
    ...
    """
    from src.infra.supabase.http_client import HTTPX_TIMEOUT, HTTPX_TIMEOUT_LIGHT
...
def test_httpx_timeout_alias_config():
    ...
    """
    from src.infra.supabase.http_client import HTTPX_TIMEOUT
...
def test_httpx_all_exports():
    ...
    """
    from src.infra.supabase import http_client
