...
def test_update_request_status_fallback_without_org_id() -> None:
    ...
    with patch("src.infra.supabase_client.supabase", mock_table):
        ...
        with patch("src.infra.repositories.anvisa_requests_repository._get_supabase_and_user") as mock_get_user:
...
def test_update_request_status_no_rows_affected() -> None:
    ...
    with patch("src.infra.supabase_client.supabase", mock_table):
        with patch("src.infra.repositories.anvisa_requests_repository._get_supabase_and_user") as mock_get_user:
            ...
            with patch("src.infra.repositories.anvisa_requests_repository._resolve_org_id") as mock_resolve:
...
def test_delete_request_success() -> None:
    ...
    from src.infra.repositories.anvisa_requests_repository import delete_request
