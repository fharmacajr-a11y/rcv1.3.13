...
from infra.repositories.passwords_repository import (
    create_password,
...
def test_create_password_chama_add_password_com_parametros_corretos() -> None:
    ...
    with patch("data.supabase_repo.add_password") as mock_add:
...
def test_update_password_by_id_chama_update_password_com_todos_parametros() -> None:
    ...
    with patch("data.supabase_repo.update_password") as mock_update:
...
def test_delete_all_passwords_for_client_retorna_count() -> None:
    ...
    with patch("data.supabase_repo.delete_passwords_by_client") as mock_delete_all:
