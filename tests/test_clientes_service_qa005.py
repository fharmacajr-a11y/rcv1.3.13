...
class TestFilterSelfQA005:
    ...
    def test_checar_duplicatas_razao_conflicts_none_explicit(self, monkeypatch):
        ...
        result = service.checar_duplicatas_para_form(valores={"Razão Social": "Test", "CNPJ": "", "Nome": "", "WhatsApp": ""}, row=None, exclude_id=None)
...
class TestGetClienteByIdQA005:
    ...
    def test_fetch_cliente_by_id_converts_to_dict(self, monkeypatch):
        ...
        fake_cliente = types.SimpleNamespace(id=42, razao_social="Test Corp", cnpj="12345678000100", observacoes="Obs test")
