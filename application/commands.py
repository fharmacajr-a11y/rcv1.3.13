...
def _bootstrap_commands() -> None:
    ...
    def _theme_switch(root: Any, theme_name: str) -> None:
        from application.api import switch_theme
    ...
    def _download_zip(
        ...
        from application.api import download_folder_zip
    ...
    def _trash_list(org_id: str) -> list:
        from application.api import list_trash_clients
    ...
    def _trash_restore(org_id: str, client_ids: list) -> bool:
        from application.api import restore_from_trash
    ...
    def _trash_purge(org_id: str, client_ids: list) -> bool:
        from application.api import purge_from_trash
    ...
    def _asset_path(name: str) -> str:
        from application.api import resolve_asset
    ...
    def _client_search(query: str, org_id: Optional[str] = None) -> list:
        from application.api import search_clients
