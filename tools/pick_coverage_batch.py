...
Uso: python tools/pick_coverage_batch.py <batch_number> [min_stmts] [max_stmts]
Exemplo: python tools/pick_coverage_batch.py 3
         python tools/pick_coverage_batch.py 4 50 100
"""
...
def main() -> None:
    if len(sys.argv) < 2:
        print("Uso: python tools/pick_coverage_batch.py <batch_number> [min_stmts] [max_stmts]")
        sys.exit(1)
