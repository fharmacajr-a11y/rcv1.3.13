...
class Toplevel(Misc):
    ...
    def transient(self, master: Misc | None = ...) -> None: ...
    def iconbitmap(self, bitmap: str | None = ..., default: str | None = ...) -> None: ...
    def lift(self, aboveThis: Misc | None = ...) -> None: ...  # noqa: N803
    def attributes(self, *args: Any) -> Any: ...
    def update(self) -> None: ...
    def minsize(self, width: int | None = ..., height: int | None = ...) -> tuple[int, int] | None: ...
...
class Canvas(Widget):
    ...
    def coords(self, tagOrId: int | str, *coords: float) -> tuple[float, ...] | None: ...  # noqa: N803
    def move(self, tagOrId: int | str, xAmount: float, yAmount: float) -> None: ...  # noqa: N803
    def itemconfigure(self, tagOrId: int | str, **kwargs: Any) -> None: ...  # noqa: N803
    def itemconfig(self, tagOrId: int | str, **kwargs: Any) -> None: ...  # noqa: N803
...
class Menu(Widget):
    ...
    def delete(self, index1: int | str, index2: int | str | None = ...) -> None: ...
    def post(self, x: int, y: int) -> None: ...
    def unpost(self) -> None: ...
    def tk_popup(self, x: int, y: int, entry: int | str = ...) -> None: ...
    def grab_release(self) -> None: ...
